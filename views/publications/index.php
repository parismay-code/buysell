...
<section class="categories-list">
    ...
    <ul class="categories-list__wrapper">
        <li class="categories-list__item">
            <a href="#" class="category-tile category-tile--default">
                <span class="category-tile__image">
                    <img src="<?= Yii::getAlias('@web/img/cat.jpg') ?>" srcset="<?= Yii::getAlias('@web/img/cat@2x.jpg') ?> 2x" alt="Иконка категории">
                </span>
        ...
        <li class="categories-list__item">
            <a href="#" class="category-tile category-tile--default">
                <span class="category-tile__image">
                    <img src="<?= Yii::getAlias('@web/img/cat02.jpg') ?>" srcset="<?= Yii::getAlias('@web/img/cat02@2x.jpg') ?> 2x" alt="Иконка категории">
                </span>
        ...
        <li class="categories-list__item">
            <a href="#" class="category-tile category-tile--default">
                <span class="category-tile__image">
                    <img src="<?= Yii::getAlias('@web/img/cat03.jpg') ?>" srcset="img/cat03@2x.jpg 2x" alt="Иконка категории">
                </span>
        ...
        <li class="categories-list__item">
            <a href="#" class="category-tile category-tile--default">
                <span class="category-tile__image">
                    <img src="<?= Yii::getAlias('@web/img/cat04.jpg') ?>" srcset="img/cat04@2x.jpg 2x" alt="Иконка категории">
                </span>
        ...
        <li class="categories-list__item">
            <a href="#" class="category-tile category-tile--default">
                <span class="category-tile__image">
                    <img src="<?= Yii::getAlias('@web/img/cat05.jpb') ?>" srcset="img/cat05@2x.jpg 2x" alt="Иконка категории">
                </span>
